...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const role = formData.get("role") as "Docente" | "Admin"
        ...
        <Card className="w-full  shadow-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex flex-col items-center justify-center">
              <span className="mb-4 text-lg">Entrar como:</span>
              <RadioGroup name="role" id="rol" className="flex gap-x-4" defaultValue="Docente">
